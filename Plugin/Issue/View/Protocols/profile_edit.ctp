<div class="issue index">
	...
	print $this->Form->hidden('Protocol.id');
	...
	$protBeginDate = $this->Form->input('Protocol.begin_date.date', array(
		...
		'class' => "small",
		'type' => 'text',
		'value' => $this->Time->format('d/m/Y', $this->request->data['Protocol']['begin_date'])
	));
	
	$protBeginTime = $this->Form->input('Protocol.begin_date.time', array(
		'class' => "mini",
		'type' => 'text',
		'value' => $this->Time->format('H:i', $this->request->data['Protocol']['begin_date'])
	));
	
	$protEndTime = $this->Form->input('Protocol.end_date.time', array(
		'class' => "mini",
		'type' => 'text',
		'value' => $this->Time->format('H:i', $this->request->data['Protocol']['end_date'])
	));
